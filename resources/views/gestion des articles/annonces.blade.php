...
<main>
    <h2>Announcements of Published Articles</h2>
        ...
        <div class="article-item">
            <div class="article-container">
                <div class="article-content">
                    ...
                    <p class="article-meta">Publised on {{ \Carbon\Carbon::parse($article->published_date)->format('d/m/Y') }} | By {{ $article->user->name }}</p>
                    <p>{{ Str::limit($article->content, 200) }}</p>

                    <a href="{{ url('/themes/' . $themeId . '/articles/' . $article->id) }}" class="read-more">read-more</a>
                    <button class="share-btn article-content"
                            data-url="{{ url('/themes/' . $themeId . '/articles/' . $article->id) }}"
